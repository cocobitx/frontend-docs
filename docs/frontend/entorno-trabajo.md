# <span style="display: flex;"><img src="/check.png" style="width: 38px; height: 38px; margin-right:10px"> Entorno de trabajo</span>

El entorno de trabajo es el conjunto de herramientas, software y configuraciones que un programador utiliza para escribir, probar y ejecutar código de manera eficiente.

![Entorno de trabajo](/entorno-trabajo.png)

¿Por qué es importante tener un buen entorno?
- Productividad: Un entorno bien configurado automatiza tareas repetitivas.
- Consistencia: Evita el famoso "en mi computadora sí funciona", asegurando que el código corra igual en todas partes.
- Depuración: Facilita encontrar errores (bugs) rápidamente mediante herramientas de inspección.
...
### Runtime
- **NodeJS** : Se utiliza como entorno de ejecución para aplicaciones y herramientas de desarrollo basadas en JavaScript, garantizando compatibilidad con el ecosistema moderno, ejecución eficiente y soporte para flujos de trabajo frontend y backend. <small>[visitar→](https://nodejs.org/en/download)</small>
...
::: details Equipo de desarrollo {open}
...
![Entorno de trabajo](/entorno-trabajo-gram.png)

::: details Versiones tecnologicas
Linux <Badge type="info" text="^6.14.0" /> <br>
Vitepress <Badge type="info" text="^2.0.0" /> <br>
Storybook <Badge type="info" text="^10.2.0" /> <br>
Git <Badge type="info" text="^2.40.0" /> <br>
NodeJS <Badge type="info" text="^20.0.0" /> <br>
npm <Badge type="info" text="^10.0.0" /> <br>
Astro <Badge type="info" text="^4.12.0" /> <br>
NuxtJS <Badge type="info" text="^4.2.2" /> <br>
Vue3 <Badge type="info" text="^3.5.0" /> <br>
Tauri <Badge type="info" text="^2.0.0" /> <br>
Ionic <Badge type="info" text="^7.0.0" />
:::
